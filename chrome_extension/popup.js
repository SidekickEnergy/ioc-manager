...
function getStoredApiKeys() {
  return new Promise((resolve) => {
    chrome.storage.local.get([
      ...
      if (data.misp_apiKey) api_keys.misp = { apiKey: data.misp_apiKey };
      if (data.edl_apiKey) api_keys.edl = { apiKey: data.edl_apiKey };
      if (data.dnsdb_apiKey) api_keys.dnsdb = { apiKey: data.dnsdb_apiKey };
